$(document).ready(function(){ 
	...
	$('#showme').click(function(){
        ...
        // alert('hello');
       var n = 1;
        $('#new'+ n).append('<div class="form-inline mt-4 mb-4 hr">\
...
$('#addr1').click(function(){
	...
	$('#cbox').click(function(){
		...
		$(addme).append("<div class='form-inline mt-4 checkbox_wrapper"+c+" rowb"+k+"'>\
			...
			<label class='control-label col-md-1'>फिल्डको नाम:</label>\
			<input type='text' class='form-control col-md-2' name='nepali[]' required>\
			<input type='hidden' name='types[]' value='checkbox"+a+"'><label class='control-label col-md-2'>Checkbox Values:</label>\
	...
	$('#dropdown').click(function(){
		...
		$(addme).append("<div class='form-inline mt-4 dropdown_wrapper"+chkk+" rowc"+n+"'>\
			...
			<input type='text' class='form-control col-md-2' name='nepali[]' required>\
			<input type='hidden' name='types[]' value='dropdown"+b+"'><label class='control-label col-md-2'>Dropdown Values:</label>\
